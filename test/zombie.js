    ...
    get_cik: (person) => {
        browser.visit("https://www.izbori.ba/Default.aspx?CategoryID=509&Lang=3").then(() => {
            ...
            browser.wait(() => {
                ...
                let sql = `UPDATE vote SET voting_location = '${person.voting_location}', voting_location_address = '${person.voting_location_address}', voting_location_name = '${person.voting_location_name}',person.voting_location_municipality = '${person.voting_location_municipality}' WHERE jmbg == '${person.jmbg}'`;
